...
import { Text } from '@/components/elements/Text'; // Your custom Text component
...
export default function SettingsScreen() {
	...
	const saveSettingsForTab = async (tab: 'store' | 'woocommerce' | 'ai', data: any) => {
		try {
			...
			toast.success(`Successfully saved ${tab} settings.`);
			loadAllSettings();
		} catch (error: any) {
			toast.error(`Failed to save ${tab} settings: ${error.message}`);
		} finally {
